...
<?php
  if(isset($_POST['product'])){
    ...
    if(empty($errors)) {
      ...
      $query  .=" buy_price ='{$p_buy}', sell_price ='{$p_sale}', category_id ='{$p_cat}',media_id='{$media_id}'";
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="selling-price" value="<?php echo remove_junk($product['sell_price']);?>">
                    <span class="input-group-addon">.00</span>
                  </div>
                </div>
              </div>
